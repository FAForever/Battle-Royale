...
AddLandEntry(0, 5, "Land T1", 4)
AddLandEntry(5, 10, "Land T1", 8)
AddLandEntry(8, 16, "Land T2", 3)
AddLandEntry(15, 25, "Land T2", 6)
...
AddLandEntry(5, 10, "Air T1", 8)
AddLandEntry(8, 16, "Air T2", 3)
AddLandEntry(15, 25, "Air T2", 6)
AddLandEntry(20, 35, "Air T2", 9)
AddLandEntry(25, 35, "Air T3", 2)
AddLandEntry(30, 50, "Air T3", 4)
AddLandEntry(50, 600, "Air T3", 8)
...
AddNavalEntry(8, 16, "Navy T2", 1)
AddNavalEntry(15, 25, "Navy T2", 2)
AddNavalEntry(20, 35, "Navy T2", 4)
