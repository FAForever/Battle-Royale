...
local Units = import("/mods/battle-royale/modules/packer/units-economic.lua").UnitTable
local BuildingPatterns = import("/mods/battle-royale/modules/packer/building-patterns.lua").Patterns
